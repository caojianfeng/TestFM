 ...
 */
public class PageAFragment extends SupportFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.tv_sub_a1).setOnClickListener(this);
        view.findViewById(R.id.tv_sub_a2).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (vid == R.id.tv_sub_a1) {
            popTo(PageAFragment.class, false);
            start(SubA1Fragment.newInstance("", ""));
        } else if (vid == R.id.tv_sub_a2) {
            popTo(PageAFragment.class, false);
            start(SubA2Fragment.newInstance("", ""));
        }else {
            pop();
        }
